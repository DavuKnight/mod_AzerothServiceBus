...
using AzerothDotNetCore.Models;
...
namespace AzerothDotNetCore
{
    ...
    {
        static IEnumerable<IPlayerEvents> eventHandlers;
        static PlayerEvents()
        {
            if (eventHandlers == null)
            {
                eventHandlers = ModuleManager.Instance.ServiceProvider.GetServices<IPlayerEvents>();
            }
